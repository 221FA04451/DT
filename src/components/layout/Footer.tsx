...
export function Footer() {
  return (
    <footer className="w-full bg-black text-zinc-500 text-[11px] font-sans antialiased border-t border-white/6">
      <div className="w-full px-8 py-12 lg:px-16">
        ...
        {/* Directory Columns */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-y-8 gap-x-4 mb-8">
          {/* Column 1 */}
          <div>
        ...
        <div className="border-t border-white/6 pt-4 flex flex-col md:flex-row items-baseline justify-between gap-4">
